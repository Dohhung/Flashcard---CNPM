    ...
    <div class="container mt-5">
        ...
        <form id="vocabularyForm">
            ...
            <div class="text-center mt-4">
                <p class="text-center">Chọn tựa game mà bạn muốn chơi</p>
                <button type="button" class="btn btn-primary me-2" onclick="redirectToGame('game.php')">Flip the card</button>
                <button type="button" class="btn btn-primary me-3" onclick="redirectToGame('game2.php')">Search Word</button>
            </div>
        </form>
    </div>
